        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('home_visits.by-patient', $homeVisit->patient) }}" class="btn btn-outline-info btn-sm">
                ...
                <div class="mt-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            <strong class="text-muted">{{ ucfirst(str_replace('_', ' ', $sinal)) }}:</strong>
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('home_visits.show', $visita) }}" class="btn btn-sm btn-outline-primary">
                ...
                <div class="d-grid gap-2">
                    @if($homeVisit->status == 'agendada')
                        @if($homeVisit->canBeCompleted())
                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#completeVisitModal">
                        ...
                        <form method="POST" action="{{ route('home_visits.mark-not-found', $homeVisit) }}" class="d-inline">
                            @csrf
                    ...
                    @if($homeVisit->status != 'realizada')
                        <form method="POST" action="{{ route('home_visits.destroy', $homeVisit) }}" class="d-inline">
                            @csrf
                            @method('DELETE')
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            <label for="observacoes_ambiente" class="form-label required">Observações do Ambiente</label>
                            <textarea class="form-control" id="observacoes_ambiente" name="observacoes_ambiente" 
                                      rows="3" required placeholder="Descreva as condições do ambiente domiciliar..."></textarea>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="estado_nutricional" name="estado_nutricional" 
                                      rows="2" placeholder="Avaliação do estado nutricional..."></textarea>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="queixas_principais" class="form-label">Queixas Principais</label>
                            <textarea class="form-control" id="queixas_principais" name="queixas_principais" 
                                      rows="2" placeholder="Principais queixas relatadas..."></textarea>
                        </div>
                        
                        <!-- Orientações -->
                        <div class="col-12 mb-3">
                            <label for="orientacoes_dadas" class="form-label required">Orientações Dadas</label>
                            <textarea class="form-control" id="orientacoes_dadas" name="orientacoes_dadas" 
                                      rows="3" required placeholder="Descreva as orientações fornecidas à gestante e família..."></textarea>
                        </div>
                        
                        <!-- Sinais Vitais -->
                        <div class="col-12 mb-3">
                            <h6 class="border-bottom pb-2">Sinais Vitais (Opcional)</h6>
                            <div class="row">
                                <div class="col-md-3 mb-2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="material_educativo" name="materiais[]" value="Material Educativo">
                                        <label class="form-check-label" for="material_educativo">Material Educativo</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="cartao_gestante" name="materiais[]" value="Cartão da Gestante">
                                        <label class="form-check-label" for="cartao_gestante">Cartão da Gestante</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="suplementos" name="materiais[]" value="Suplementos">
                                        <label class="form-check-label" for="suplementos">Suplementos</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="preservativos" name="materiais[]" value="Preservativos">
                                        <label class="form-check-label" for="preservativos">Preservativos</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="medicamentos" name="materiais[]" value="Medicamentos">
                                        <label class="form-check-label" for="medicamentos">Medicamentos</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="outros_materiais" name="materiais[]" value="Outros">
                                        <label class="form-check-label" for="outros_materiais">Outros</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="acompanhante_presente" name="acompanhante_presente" value="1">
                                <label class="form-check-label" for="acompanhante_presente">
                                    Acompanhante Presente
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="necessita_referencia" name="necessita_referencia" value="1">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('home_visits.reschedule', $homeVisit) }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="motivo_reagendamento" class="form-label required">Motivo do Reagendamento</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle vital signs collection
    const vitalSignsInputs = ['pressao_arterial', 'frequencia_cardiaca', 'temperatura', 'peso'];
    const completeForm = document.querySelector('#completeVisitModal form');
    ...
    if (completeForm) {
        completeForm.addEventListener('submit', function() {
            ...
            // Handle materials
            const selectedMaterials = Array.from(document.querySelectorAll('input[name="materiais[]"]:checked'))
