...
class AlertaController extends Controller
{
    ...
    public function transitar(Request $request, Alerta $alerta): RedirectResponse
    {
        ...
        // Verificação de permissões Spatie (Administrador, Médico, Enfermeira, Parteira ou com permissão manage_alerts)
        if (!$user || (!$user->can('manage_alerts') && !$user->hasRole(['Administrador', 'Médico', 'Enfermeira', 'Parteira', 'Tecnico']))) {
