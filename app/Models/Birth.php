...
class Birth extends Model
{
    ...
    protected $casts = [
        ...
        'perimetro_craniano' => 'decimal:1',
        'parto_multiplo' => 'boolean',
        'reanimacao_rn' => 'boolean',
        'aspiracao_rn' => 'boolean',
        'profilaxia_ocular' => 'boolean',
        'vitamina_k' => 'boolean',
        'anomalia_congenita' => 'boolean',
        'aleitamento_primeira_hora' => 'boolean',
        'vacina_bcg' => 'boolean',
        'vacina_polio_0' => 'boolean',
        'mae_vitamina_a' => 'boolean',
        'puerperio_febre' => 'boolean',
        'puerperio_hemorragia' => 'boolean',
    ];
